...
class Dialog(wx.Dialog):
    ...
    def __init__(self, parent, title):
        ...
        hbSTconsumerSecret.Add(wx.StaticText(panel,
                                             -1,
                                             'Consumer Secret'
                                             ),
        ...
        hbSTconsumerKey.Add(wx.StaticText(panel,
                                          -1,
                                          'Consumer Key'
                                          ),
                            flag=wx.LEFT | wx.TOP, border=3)
        ...
        hbSTaccessTokenSecret.Add(wx.StaticText(panel,
                                                -1,
                                                'Access Token Secret'
                                                ),
                                  flag=wx.LEFT | wx.TOP, border=3)
        ...
        hbSTaccessTokenKey.Add(wx.StaticText(panel,
                                             -1,
                                             'Access Token Key'
                                             ),
                               flag=wx.LEFT | wx.TOP, border=3)
        ...
        hbSTserialPort.Add(wx.StaticText(panel,
                                         -1,
                                         'Serial Port'
                                         ),
                           flag=wx.LEFT | wx.TOP, border=3)
        ...
        self.s_port = wx.TextCtrl(panel,
                                  -1,
                                  self.parent.c.s_port,
                                  size=(500, 23))
